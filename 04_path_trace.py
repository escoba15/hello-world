...
post_url = "https://sandboxapicem.cisco.com/api/v1/flow-analysis"   #URL of API endpoint
...
resp = requests.get(post_url, headers=headers, verify=False)

print("Status of path request: ", resp.status_code)
#++++++++++++++++++++++++++++++++++++
...
while True:
    #+++++++++++Add Values+++++++++++++++
    s_ip = input("Source IP: ") # Request user input for source IP address
    d_ip = input("Destination IP: ") # Request user input for destination IP address
    #++++++++++++++++++++++++++++++++++++
...
resp = requests.post(post_url, path, headers=headers, verify=False)#Make the request. Construct the post request to the API

# Inspect the return, get the Flow Analysis ID, put it into a variable
resp_json = resp.json()
flowAnalysisId = resp_json["response"]["flowAnalysisId"] # Assign the value of the flowAnalysisID key of resp_json.
#+++++++++++++++++++++++++++++++++++++
...
check_url = post_url + "/" + flowAnalysisId #Append the flowAnalyisId to the flow analysis end point URL that was created in Section 1
#print(check_url)
#++++++++++++++++++++++++++++++++++++
